                ...
                if (data.error) {
                                    ...
                                    <table class="tabla-casos">
                                        ...
                                        <tbody>
                                            ${data.casos.map(caso => `
                                                <tr>
                                                    <td>
                                                        <a href="/detalle-caso?id=${caso.numero}" class="enlace-caso">
                                                            ${caso.numero}
                                                        </a>
                                                    </td>
                                                    <td>${caso.tipo}</td>
                    ...
                    document.getElementById('detalle-contacto').innerHTML = `
                        <div class="info-contacto">
                            <p><strong>Esta es la cuenta de: </strong>${data.nombre_rol} <strong>, </strong>${data.nombre} ${data.apellido}</p>
                            <p><strong>Correo:</strong> ${data.correo || 'No especificado'}</p>
                            <p><strong>Teléfono:</strong> ${data.telefono || 'No especificado'}</p>
                            <p><strong>País de origen: </strong> ${data.pais || 'No especificado'}</p>
                        </div>
                        ${casosHTML}
                    `;
                }
